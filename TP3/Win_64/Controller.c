                    ...
                    for(int j=i+1;j<len;j++)
                        {
                            ...
                            if(strcasecmp(empleadoA->nombre, empleadoB->nombre)>0)
                                {
            ...
            for(int i=0;i<len;i++)
                {
                    ...
                    employee_getId(nuevoEmpleado, &auxId);
                    employee_getNombre(nuevoEmpleado, auxNombre);
                    employee_getHorasTrabajadas(nuevoEmpleado,&auxHorasTrabajadas);
                    employee_getSueldo(nuevoEmpleado,&auxSueldo);
